            ...
            <div class="row q-col-gutter-xs">
                    ...
                    <div class="my-content">
                        ...
                        >
                         <template v-slot:prepend>
                          <q-icon name="place" color="green-2" />
                        </template>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div style="margin-top:15px">
                        <q-btn outline size="md" color="teal-4">Search</q-btn>
                    </div>
                </div>
            </div>
        </div>
			<q-list>
				<q-item class="post" >
                    ...
                    <q-item-section>
							...
							<q-item-label caption lines="2">Seconddddary line text. Lorem ipsum dolor sit amet, consectetur adipiscit elit.</q-item-label>
                    </q-item-section>
                    <q-item-section side top>
							<q-item-label caption class="text-black">5 min ago</q-item-label>
							<q-icon name="star" color="yellow" />
                            <q-btn size="sm" outline @click="$router.push({ name: 'detail'})">View</q-btn>
                    </q-item-section>
                </q-item>
                ...
                <q-item class="post">
                    ...
                    <q-item-section side top>
								<q-item-label caption class="text-black">Voted!</q-item-label>
                    </q-item-section>
                </q-item>
						<!-- <q-separator spaced inset /> -->
						<q-item class="post">
